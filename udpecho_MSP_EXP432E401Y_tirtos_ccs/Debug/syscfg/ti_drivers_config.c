 ...
 */
extern void gpioButtonSW1Callback(uint_least8_t index);
extern void gpioButtonSW2Callback(uint_least8_t index);
...
GPIO_CallbackFxn gpioCallbackFunctions[] = {
    ...
    NULL,
    /* CONFIG_GPIO_6 : LaunchPad Button USR_SW1 (Left) */
    gpioButtonSW1Callback,
    /* CONFIG_GPIO_7 : LaunchPad Button USR_SW2 (Right) */
    gpioButtonSW2Callback,
};
...
const Timer_Config Timer_config[CONFIG_TIMER_COUNT] = {
    ...
    {
        .fxnTablePtr = &TimerMSP432E4_fxnTable,
        .object      = &timerMSP432E4Objects[CONFIG_TIMER_2],
        .hwAttrs     = &timerMSP432E4HWAttrs[CONFIG_TIMER_2]
    },
};
